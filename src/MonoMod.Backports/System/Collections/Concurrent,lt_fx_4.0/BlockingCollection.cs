...
#pragma warning restore CA2213
            ...
            while (millisecondsTimeout == Timeout.Infinite || timeout >= 0)
            {
                ...
                using (CancellationTokenSource linkedTokenSource = CancellationTokenSource.CreateLinkedTokenSource(collatedCancellationTokens))
                {
                    ...
                    if (linkedTokenSource.IsCancellationRequested)
                    {
                        ...
                        throw new ArgumentException("BlockingCollection_CantAddAnyWhenCompleted", nameof(collections)); //case#4
                    }
                }
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(index), index, "BlockingCollection_CopyTo_NonNegative");
            }
            ...
            {
                throw new ArgumentException("BlockingCollection_CopyTo_MultiDim", nameof(array));
            }
            catch (InvalidCastException)
            {
                throw new ArgumentException("BlockingCollection_CopyTo_IncorrectType", nameof(array));
            }
        ...
        private static void ValidateCollectionsArray(BlockingCollection<T>[] collections, bool isAddOperation)
        {
                ...
                ((collections.Length == 63) && (Thread.CurrentThread.GetApartmentState() == ApartmentState.STA)))
            {
                ...
                throw new ArgumentOutOfRangeException(
                    nameof(collections), "BlockingCollection_ValidateCollectionsArray_LargeSize");
            }
            ...
            for (int i = 0; i < collections.Length; ++i)
            {
                ...
                if (collections[i]._isDisposed)
                    throw new ObjectDisposedException(
                        nameof(collections), "BlockingCollection_ValidateCollectionsArray_DispElems");
        ...
        private static void ValidateTimeout(TimeSpan timeout)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(timeout), timeout, "BlockingCollection_TimeoutInvalid");
            }
        }
        ...
        private static void ValidateMillisecondsTimeout(int millisecondsTimeout)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(millisecondsTimeout), millisecondsTimeout, "BlockingCollection_TimeoutInvalid");
            }
        }
