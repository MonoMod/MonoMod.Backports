...
#pragma warning restore CS8762
        ...
        public void CopyTo(T[] array, int index)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("Array is too short", nameof(index));
                }
        ...
        {
            get { throw new NotSupportedException("Concurrent collection sync root not supported"); }
        }
        ...
        private void FreezeBag(ref bool lockTaken)
        {
            ...
            //Debug.Assert(!Monitor.IsEntered(GlobalQueuesLock));
            MonitorEx.Enter(GlobalQueuesLock, ref lockTaken);
            ...
            {
                MonitorEx.Enter(queue, ref queue._frozen);
            }
            Thread.MemoryBarrier(); // prevent reads of _currentOp from moving before writes to _frozen
        ...
        private sealed class WorkStealingQueue
        {
            ...
            {
                Debug.Assert(Thread.CurrentThread.ManagedThreadId == _ownerThreadId);
                bool lockTaken = false;
                try
                {
...
#pragma warning disable CA1508 // Avoid dead conditional code
            ...
            internal int DangerousCount
            {
                get
                {
                    // TODO: implement Monitor.IsEntered
                    //Debug.Assert(Monitor.IsEntered(this));
        ...
        private sealed class Enumerator : IEnumerator<T>
        {
            ...
            object? IEnumerator.Current
            {
                get
                {
                    ...
                    {
                        throw new InvalidOperationException("Concurrent bag enumeration not started");
                    }
                    return Current;
                }
            }
