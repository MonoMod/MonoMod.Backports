    ...
    internal sealed class DelegatingTypeInfo : TypeInfo
    {
                        ...
                        Type? returnType, Type[]? types, ParameterModifier[]? modifiers)
        {
            if (returnType == null && types == null)
                ...
                return typeImpl.GetProperty(name, bindingAttr, binder, returnType, types ?? new Type[0], modifiers);
        }
        ...
        //public override bool IsByRefLike => typeImpl.IsByRefLike; // IsByRefLike is implemented in the runtime as an internalcall
