...
namespace System.Threading
{
    ...
    public class SemaphoreSlim : IDisposable
    {
        ...
        public SemaphoreSlim(int initialCount, int maxCount)
        {
            if (initialCount < 0 || initialCount > maxCount)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(initialCount), initialCount, "SemaphoreSlim_ctor_InitialCountWrong");
            }

            // validate input
            if (maxCount <= 0)
            {
                throw new ArgumentOutOfRangeException(nameof(maxCount), maxCount, "SemaphoreSlim_ctor_MaxCountWrong");
            }

            m_maxCount = maxCount;
            m_currentCount = initialCount;
            m_lockObjAndDisposed = new StrongBox<bool>(false);
        }
        ...
        public bool Wait(TimeSpan timeout)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    nameof(timeout), timeout, "SemaphoreSlim_Wait_TimeoutWrong");
            }
        ...
        public bool Wait(int millisecondsTimeout, CancellationToken cancellationToken)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    nameof(millisecondsTimeout), millisecondsTimeout, "SemaphoreSlim_Wait_TimeoutWrong");
            }
        ...
        */
        ...
        public int Release(int releaseCount)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    nameof(releaseCount), releaseCount, "SemaphoreSlim_Release_CountWrong");
            }
            int returnCount;
        ...
        /// <see cref="SemaphoreSlim"/>, and optionally releases the managed resources.
        /// </summary>
