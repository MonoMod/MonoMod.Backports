...
using Accessibility = ArApiCompat.Utilities.AsmResolver.Accessibility;
...
public sealed class CannotChangeVisibility : BaseRule
{
    ...
    private static int CompareAccessibility(Accessibility a, Accessibility b)
    {
    ...
    private static void Run(IMemberDefinition? left, IMemberDefinition? right, IList<CompatDifference> differences)
    {
        ...
        var accessComparison = CompareAccessibility(leftAccess, rightAccess);
